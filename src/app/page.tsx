...
export default function Home() {
  const { currentView, sidebarOpen, authenticated, authLoading, setUser, setAuthLoading, logout } = useAppStore()
  ...
  const handleLogin = (user: { userId: string; email: string; name: string; role: string }) => {
    setUser(user)
  }
