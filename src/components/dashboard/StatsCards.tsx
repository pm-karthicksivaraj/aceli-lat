...
export function StatsCards({ stats, loading }: StatsCardsProps) {
  ...
  const cards = [
    ...
    },
    {
      ...
      icon: AlertTriangle,
      color: (stats.openExceptions || 0) > 0 ? "text-orange-600" : "text-green-600",
      bgColor: (stats.openExceptions || 0) > 0 ? "bg-orange-50" : "bg-green-50",
      subtext: (stats.openExceptions || 0) > 0 ? "Needs attention" : "All clear",
    },
    {
      label: "Pending Write-backs",
      value: stats.pendingWritebacks || 0,
      icon: ArrowRightLeft,
      color: (stats.pendingWritebacks || 0) > 0 ? "text-amber-600" : "text-green-600",
      bgColor: (stats.pendingWritebacks || 0) > 0 ? "bg-amber-50" : "bg-green-50",
      subtext: "To Salesforce",
    },
    {
      label: "Audit Entries (24h)",
      value: stats.auditLogCount || 0,
      icon: FileText,
